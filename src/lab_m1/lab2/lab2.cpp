...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        vector<VertexFormat> vertices_sq
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        vector<unsigned int> indices_sq =
        {
            0, 1, 2,
            0, 1, 3,
        };

        vector<VertexFormat> vertices_prs
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 0
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 1
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 2
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 3
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 4
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 5
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 6
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 7
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 8
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 9
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 10
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 11
        };

        vector<unsigned int> indices_prs =
        {
            0, 3, 6,
            1, 7, 9,
            2, 10, 4,
        ...
        CreateMesh("tetr", vertices_t, indices_t);

        CreateMesh("square", vertices_sq, indices_sq);
        CreateMesh("prs", vertices_prs, indices_prs);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetr"], shaders["VertexColor"], glm::vec3(3, 3, 3), glm::vec3(0.25f));
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(2, 3, 3), glm::vec3(0.25f));
    RenderMesh(meshes["prs"], shaders["VertexColor"], glm::vec3(1, 3, 3), glm::vec3(0.25f));
